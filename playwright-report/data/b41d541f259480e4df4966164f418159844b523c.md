...
- Name: animations.spec.ts >> Animations and Micro-interactions >> test_f3_t2_rapid_hover: verify rapid hover in/out does not lock elements in incorrect scaling state
- Location: tests\animations.spec.ts:89:3

# Error details

```
Error: No button/link found to test rapid hover
```
