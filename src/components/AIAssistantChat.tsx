    ...
    setMessages([
      {
        ...
        text: lang === "ar" 
          ...
          : (customWelcomeEn || "Welcome! I am the OSERA Enterprise Technical Lead Assistant. I can help you blueprint high-performance Django architectures, eliminate database N+1 bottlenecks, handle cash caching schemes, or coordinate a secure meeting with our founder Osama Esmael. How can I help you today?")
      }
    ]);
  ...
  const contactLinks = [
    {
      ...
      val: "01066906132",
      icon: <Phone className="h-4 w-4 text-emerald-400 shrink-0" />,
      url: "https://wa.me/201066906132",
      bg: "hover:bg-emerald-950/40 hover:border-emerald-500/30",
    ...
    },
    {
      ...
      icon: <Award className="h-4 w-4 text-emerald-400 shrink-0" />,
      url: "https://www.upwork.com/freelancers/~01bf4f5af0779c48e8?mp_source=share",
      bg: "hover:bg-emerald-950/30 hover:border-emerald-500/30",
      lbl: "Verified Upwork"
    },
    {
      name: "LinkedIn Strategic Network",
      val: "Osama Deghadey",
      icon: <Share2 className="h-4 w-4 text-blue-400 shrink-0" />,
      url: "https://www.linkedin.com/in/osama-deghadey-941552255/",
      bg: "hover:bg-blue-950/30 hover:border-blue-500/30",
      lbl: "Professional ID"
    },
    {
    ...
    },
    {
      ...
      icon: <HelpCircle className="h-4 w-4 text-indigo-400 shrink-0" />,
      url: "https://profile.indeed.com/?hl=en_EG&co=EG&from=gnav-homepage",
      bg: "hover:bg-indigo-950/30 hover:border-indigo-500/30",
      lbl: "Indeed EG"
    },
    {
      name: "Facebook Corporate Contact",
      val: "Osama Esmael Page",
      icon: <MessageCircle className="h-4 w-4 text-blue-500 shrink-0" />,
      url: "https://www.facebook.com/share/1cFNBCGtwA/",
      bg: "hover:bg-blue-950/20 hover:border-blue-500/20",
    ...
    <>
      ...
      {!isOpen && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-50 h-13 w-13 rounded-full bg-gradient-to-br from-cyan-400 via-cyan-500 to-indigo-600 text-white flex items-center justify-center shadow-[0_8px_32px_rgba(6,182,212,0.3)] ring-2 ring-cyan-300/40 cursor-pointer select-none"
        >
            ...
            <div className="p-4 bg-zinc-950/90 border-b border-zinc-900/60 flex items-center justify-between relative">
              <div className="flex items-center gap-3">
                <div className="relative flex -space-x-1.5">
                  <div className="h-9 w-9 rounded-full border border-cyan-500/50 overflow-hidden bg-zinc-950 z-10 shadow-lg">
                    <img src={osamaAvatarImg} alt="Osama E." className="h-full w-full object-cover" referrerPolicy="no-referrer" />
                  </div>
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="flex h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse mt-0.5"></span>
                  </div>
                  <span className="text-[9px] text-cyan-400 uppercase font-mono tracking-widest block mt-0.5">
            ...
            <div className="grid grid-cols-3 p-1.5 bg-zinc-950 border-b border-zinc-900 text-[11px] font-sans font-black uppercase text-center shrink-0">
              <button
                ...
                className={`py-1.5 rounded-xl transition-all duration-300 flex items-center justify-center gap-1.5 cursor-pointer ${
                  activeTab === "chat" 
                    ? "bg-gradient-to-r from-cyan-950/80 to-indigo-950/80 text-cyan-400 border border-cyan-800/30 shadow-[inset_0_1px_4px_rgba(6,182,212,0.15)]" 
            ...
            <div className="flex-1 overflow-y-auto p-4 custom-scrollbar bg-gradient-to-b from-[#060609]/40 to-[#0e0e15]/65">
                ...
                <div ref={scrollRef} className="space-y-4 font-sans text-xs pb-2 scroll-smooth">
                  {messages.map((msg, i) => {
                    ...
                    return (
                      ...
                      >
                        {isModel && (
                          <div className="h-6 w-6 rounded-full bg-cyan-950 border border-cyan-500/30 flex items-center justify-center shrink-0">
                        ...
                        <div
                          className={`max-w-[82%] px-3.5 py-2.5 rounded-2xl leading-relaxed break-words relative overflow-hidden border ${
                            isModel
                              ...
                              : "bg-gradient-to-r from-cyan-950/50 to-indigo-950/15 border-cyan-900/40 text-cyan-150"
                          }`}
                        >
                          {msg.text.split("\n\n").map((para, pIdx) => (
                  ...
                  {isLoading && (
                    <div className="flex gap-2.5 justify-start">
                      <div className="h-6 w-6 rounded-full bg-cyan-950 border border-cyan-500/30 flex items-center justify-center shrink-0">
                        <Sparkles className="h-3 w-3 text-cyan-450 animate-spin" />
                      </div>
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {suggestChips.map((preset, i) => (
                          <button
                            ...
                            className="px-2.5 py-1.5 rounded-xl bg-zinc-950 hover:bg-zinc-900 text-left border border-zinc-900 text-[10px] text-zinc-400 hover:text-cyan-300 transition-all duration-200 cursor-pointer block truncate max-w-full"
                          >
                            {preset}
                          </button>
                        ))}
              ...
              {activeTab === "portfolio" && (
                <div className="space-y-4 font-sans text-xs">
                  <div className="p-3.5 rounded-2xl bg-[#09090d]/80 border border-cyan-500/15 text-center mb-1">
                    <Award className="h-5 w-5 text-cyan-450 mx-auto mb-1.5 animate-bounce" />
                  ...
                  <div className="space-y-2.5">
                    {portfolioProjects.map((p, idx) => (
                      <motion.a
                        ...
                        className="block p-3 rounded-2xl bg-zinc-950/70 hover:bg-zinc-900/70 border border-zinc-900 hover:border-cyan-500/30 transition-all duration-300 group"
                      >
                        <div className="flex items-start justify-between">
                          <div>
                            <span className="text-[9px] font-mono text-cyan-450 uppercase font-black bg-cyan-950/40 px-2 py-0.5 rounded-md">
                              {p.category}
                            </span>
                            <h6 className="font-extrabold text-white text-[12px] mt-1.5 group-hover:text-cyan-400 transition-colors">
                              {p.title}
                            </h6>
                          ...
                          <div className="h-7 w-7 rounded-lg bg-zinc-900 group-hover:bg-cyan-950 flex items-center justify-center text-zinc-500 group-hover:text-cyan-400 transition-colors border border-zinc-800 shrink-0">
                  ...
                  <div className="grid gap-2">
                    {contactLinks.map((c, idx) => (
                      ...
                      >
                        ...
                        <span className="text-[9px] font-mono font-bold text-zinc-500 group-hover:text-cyan-400 transition-colors uppercase bg-zinc-900 px-2 py-1 rounded-lg">
                          {c.lbl}
                        </span>
                      </motion.a>
                    ))}
